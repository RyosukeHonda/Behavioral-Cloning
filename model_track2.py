...
driving_log = pd.read_csv("track2/driving_log.csv").reset_index()
...
model.add(Convolution2D(24, 5, 5, subsample=(2,2), name='Conv1',input_shape=(3,66,200)))
model.add(ELU())
